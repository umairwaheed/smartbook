          ...
          <ul className="space-y-4">
            {Object.entries(analysis.characters).map(([characterName, details]) => (
              <li key={characterName} className="p-4 border border-gray-300 rounded-lg">
                ...
                {details.arc && (
                  <div className="mt-2">
                    <h5 className="text-md font-semibold text-red-600">Arc:</h5>
                    <p className="text-gray-700">{details.arc}</p>
                  </div>
                )}

                {details.personality && (
                  <div className="mt-2">
                    <h5 className="text-md font-semibold text-red-600">Personality:</h5>
